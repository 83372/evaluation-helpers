...
curl -X GET   -H "User-Agent: $USER_AGENT"   "https://$GITHUB_API@api.github.com/repos/83372/practice_language_basics/issues/$ISSUE_NUMBER/comments" | jq '.[] | .id' > comments.txt
